...
const FALLBACK_2026: Array<{ date: string; title: string }> = [
  ...
  { date: "2026-04-02", title: "ערב פסח" },
  { date: "2026-04-03", title: "פסח" },
  { date: "2026-04-08", title: "שביעי של פסח" },
  { date: "2026-04-09", title: "אסרו חג" },
  { date: "2026-04-15", title: "יום השואה" },
  { date: "2026-04-22", title: "יום הזיכרון" },
  { date: "2026-04-23", title: "יום העצמאות" },
  { date: "2026-05-22", title: "שבועות" },
  { date: "2026-09-12", title: "ערב ראש השנה" },
  { date: "2026-09-13", title: "ראש השנה" },
  { date: "2026-09-14", title: "ראש השנה ב׳" },
  { date: "2026-09-21", title: "ערב יום כיפור" },
  { date: "2026-09-22", title: "יום כיפור" },
  { date: "2026-09-27", title: "סוכות" },
  { date: "2026-10-04", title: "שמחת תורה" },
