...
/**
 * הגשת נכסי מותג שהועלו בשאלון הכניסה — רק למשתמשים מחוברים.
 * ה-store פרטי, לכן הצוות צופה בקבצים דרך ה-route הזה בלבד.
 * GET /api/blob/onboarding?url=<blobUrl>[&download=1]
 */
