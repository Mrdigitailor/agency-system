...
function mapLead(l: Record<string, unknown>): Lead {
  return {
    ...
    nextActionType: (l.nextActionType as string) ?? "",
    nextActionNote: (l.nextActionNote as string) ?? "",
    stageChangedAt: (l.stageChangedAt as string) ?? "",
    expectedCloseDate: (l.expectedCloseDate as string) ?? "",
    closeReason: (l.closeReason as string) ?? "",
    closeReasonDetails: (l.closeReasonDetails as string) ?? "",
    proposalStatus: (l.proposalStatus as string) ?? "",
    proposalAmount: (l.proposalAmount as number) ?? 0,
    ...
    qualityRating: (l.qualityRating as number) ?? 0,
